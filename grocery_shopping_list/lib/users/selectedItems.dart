...
class SellectedItemsPage extends StatefulWidget {
  ...
  SellectedItemsPage({Key? key, required this.selectedItems, required this.title})
      : super(key: key);
      ...
      builder: (BuildContext context) {
        ...
        void editItem(int index) {
          showDialog(
            context: context,
            builder: (BuildContext context) {
              final editItemController = TextEditingController(text: editedItems[index]);
          ...
          TextButton(
            onPressed: () {
              ...
              if (newTitle.isNotEmpty) {
                final newList = [...widget.selectedItems, newTitle, ...items];
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      style: IconButton.styleFrom(
                        foregroundColor: Color.fromARGB(255, 110, 9, 121),
                        hoverColor: Color.fromARGB(223, 201, 176, 204)
                      ),
